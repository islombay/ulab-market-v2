...
//	}
//
//	v1.service.Store().Create()
//	resp, err := v1.service.Store().Create(context.Background(), request)
//	if err != nil {
//		v1.log.Error("error is while creating  storage", logger.Error(err))
//		return
//	}
...
//// @Failure      404  {object}  models_v1.Response "Page not found"
//// @Failure      500  {object}  models_v1.Response "Interval server error"
//func (v1 *Handlers) GetStorage(c *gin.Context) {
//	id := c.Param("id")
//
//	resp, err := v1.services.StorageService().Get(context.Background(), &pbr.PrimaryKey{
//		Id: id,
//	})
//	if err != nil {
...
//	}
//
//	resp, err := v1.services.StorageService().GetList(context.Background(), &pbr.GetRequest{
//		Page:   int32(page),
//		Limit:  int32(limit),
...
//	request.Id = uid
//
//	resp, err := v1.services.StorageService().Update(context.Background(), &request)
//	if err != nil {
//		handleResponse(c, v1.log, "error is while getting storage by id", http.StatusInternalServerError, err.Error())
//		return
//	}
...
//	uid := c.Param("id")
//
//	if _, err := v1.services.StorageService().Delete(context.Background(), &pbr.PrimaryKey{
//		Id: uid,
//	}); err != nil {
